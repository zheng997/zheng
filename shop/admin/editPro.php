...
$id=$_GET['id'];
$sql="select p.id,p.pName,p.pSn,p.pNum,p.mPrice,p.iPrice,p.pDesc,p.pubTime,p.isShow,p.isHot,c.cName,p.cId from pro as p join cate c on p.cId=c.id and p.id=$id";
$proInfos=fetchAll($sql);
//var_dump($proInfos);
?>
<!doctype html>
<html>
...
<table width="70%"  border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
	  <?php foreach($proInfos as $proInfo) { ?>
    <tr>
